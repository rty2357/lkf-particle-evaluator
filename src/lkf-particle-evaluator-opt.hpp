/*
 * lkf-particle-evaluator-opt.hpp
 *
 *  Created on: 2012/03/14
 *      Author: tyamada
 */

#ifndef LKF_PARTICLE_EVALUATOR_OPT_HPP_
#define LKF_PARTICLE_EVALUATOR_OPT_HPP_
...
namespace lkf {
	// ---> namespace Particle Evaluator
	namespace peval {
		const char ConfFile[] = "lkf-particle-evaluator.conf";
...
#endif /* LKF_PARTICLE_EVALUATOR_OPT_HPP_ */
